...
- 日常任务按[工程链6.2](docs/engineering/00-engineering-chain.md#62-delivery-unit认领实施与交接)的精简流程执行：即将开工可一次CLAIMED认领，复用当前DU/计划及无冲突工作树，澄清收敛后集中落字，验证与投影集中收口。不把一个小改动扩成多轮全套流程。
