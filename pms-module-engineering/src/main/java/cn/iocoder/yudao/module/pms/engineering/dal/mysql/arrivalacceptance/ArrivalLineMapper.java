...
public interface ArrivalLineMapper extends BaseMapperX<ArrivalLineDO> {
    ...
    List<ArrivalLineDO> selectCurrentListByAcceptanceIdsInternal(
            @Param("query") ArrivalChildrenBatchQuery query);

    default List<ArrivalLineDO> selectCurrentListByAcceptanceIds(ArrivalChildrenBatchQuery query) {
