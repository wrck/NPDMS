...
/**
 * 管理后台 - 需求分析新增/修改 Request VO（FR-ENG-004）。
 */
@Schema(description = "管理后台 - 需求分析新增/修改 Request VO")
@Data
public class RequirementSaveReqVO {
    ...
    @Schema(description = "需求类型 BUSINESS 业务需求 / INTERFACE 接口规划", example = "BUSINESS")
    private String requirementType;

    @Schema(description = "关联文档模板ID（V36 结构化文档模板）", example = "40001")
    ...
    @Schema(description = "接口关系内容（type=INTERFACE 时使用）")
