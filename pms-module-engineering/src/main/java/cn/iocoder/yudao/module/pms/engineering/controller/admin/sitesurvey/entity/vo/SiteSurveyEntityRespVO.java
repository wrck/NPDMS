...
@Data
public class SiteSurveyEntityRespVO {
    ...
    private java.util.Map<String, String> fieldBindings;
    private java.util.List<cn.iocoder.yudao.module.pms.platform.api.entity.EntityField> fieldCatalog;
