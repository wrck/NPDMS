...
class CutoverClosureQueryServiceTest {
    ...
    void returnsDraftDetailAndStableAllowedActions() {
        ...
        task.setOwnerUserId(9L); task.setVersion(7); task.setDeviceScopeWatermark("device-watermark-1");
        ...
        approval.setVersion(4); approval.setProjectId(10L); approval.setPlanRevisionNo(2);
        CutoverClosureDO closure = new CutoverClosureDO(); closure.setId(400L); closure.setTenantId(1L);
        closure.setTaskId(100L); closure.setProjectId(10L); closure.setTaskVersionAtP6(7);
        closure.setPlanRevisionId(300L); closure.setPlanRevisionNo(2); closure.setPlanVersion(6);
        closure.setApprovalInstanceId(200L); closure.setApprovalVersion(4);
        closure.setDeviceScopeWatermark("device-watermark-1");
        ...
        closure.setFinalResultCode(null);
