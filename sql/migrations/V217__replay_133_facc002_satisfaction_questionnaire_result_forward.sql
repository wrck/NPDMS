-- Chronologically replayed from a43ed4c1c7e7ecec2a2923aa3914fda566eb4e67 (codex/f-acc-001-sds), original sql/migrations/V133__facc002_satisfaction_questionnaire_result_forward.sql.
...
DELIMITER $$
CREATE PROCEDURE `facc002_preflight_v133`()
BEGIN
  ...
  IF managed_role_count <> 1 OR parent_menu_count <> 1 THEN
    SIGNAL SQLSTATE '45000'
      SET MESSAGE_TEXT='F-ACC-002 V133 managed role or menu parent prerequisite mismatch';
  END IF;
  ...
  ELSEIF target_table_count=12 AND exact_table_shape_count=12
    ...
    SET @facc002_v133_apply=0;
  ELSE
    SIGNAL SQLSTATE '45000'
      SET MESSAGE_TEXT='F-ACC-002 V133 target structures or managed configuration are partial or conflicting';
  END IF;
END$$
DELIMITER ;

CALL `facc002_preflight_v133`();
DROP PROCEDURE IF EXISTS `facc002_preflight_v133`;

SET @facc002_v133_alter_task = IF(@facc002_v133_apply=1,
  ...
  'DO 0');
PREPARE facc002_v133_alter_task_stmt FROM @facc002_v133_alter_task;
EXECUTE facc002_v133_alter_task_stmt;
DEALLOCATE PREPARE facc002_v133_alter_task_stmt;
...
VALUES
(930930,'满意度管理','',1,20,19260,'satisfaction','ep:chat-line-square','',NULL,0,b'1',b'1',b'1','facc002_v133',NOW(),'facc002_v133',NOW(),b'0'),
(930931,'满意度查询','pms:acceptance:satisfaction:query',3,10,930930,'','',NULL,NULL,0,b'1',b'1',b'1','facc002_v133',NOW(),'facc002_v133',NOW(),b'0'),
(930932,'满意度管理','pms:acceptance:satisfaction:manage',3,20,930930,'','',NULL,NULL,0,b'1',b'1',b'1','facc002_v133',NOW(),'facc002_v133',NOW(),b'0'),
(930933,'满意度采集','pms:acceptance:satisfaction:collect',3,30,930930,'','',NULL,NULL,0,b'1',b'1',b'1','facc002_v133',NOW(),'facc002_v133',NOW(),b'0'),
(930934,'满意度导出','pms:acceptance:satisfaction:export',3,40,930930,'','',NULL,NULL,0,b'1',b'1',b'1','facc002_v133',NOW(),'facc002_v133',NOW(),b'0'),
(930935,'满意度下载','pms:acceptance:satisfaction:download',3,50,930930,'','',NULL,NULL,0,b'1',b'1',b'1','facc002_v133',NOW(),'facc002_v133',NOW(),b'0');

INSERT INTO `system_role_menu`
(`role_id`,`menu_id`,`creator`,`create_time`,`updater`,`update_time`,`deleted`,`tenant_id`)
SELECT 992004800002, menu_id, 'facc002_v133', NOW(), 'facc002_v133', NOW(), b'0', 0
...
VALUES
(992005900001,'满意度任务事件投递',1,'satisfactionTaskOutboxDeliveryJob','','0/30 * * * * ?',0,0,0,'facc002_v133',NOW(3),'facc002_v133',NOW(3),b'0'),
(992005900002,'满意度结果事件投递',1,'satisfactionResultOutboxDeliveryJob','','0/30 * * * * ?',0,0,0,'facc002_v133',NOW(3),'facc002_v133',NOW(3),b'0'),
(992005900003,'满意度归档补偿',1,'satisfactionResultArchiveCompensationJob','','0/30 * * * * ?',0,0,0,'facc002_v133',NOW(3),'facc002_v133',NOW(3),b'0'),
(992005900004,'统一导出任务执行',1,'exportTaskExecutionJob','','0/30 * * * * ?',0,0,0,'facc002_v133',NOW(3),'facc002_v133',NOW(3),b'0'),
(992005900005,'统一导出文件到期',1,'exportFileExpirationJob','','0 0/5 * * * ?',0,0,0,'facc002_v133',NOW(3),'facc002_v133',NOW(3),b'0');
