...
> 本节记录2026-08-05的历史52表验证，不代表ADR-0019～ADR-0021后的当前53表草案已经执行验证。当前草案为1,113列、79个外键、83个CHECK，必须在`AI-MIG-000`签署后重新进行隔离MySQL验证；其中`cus_market_relation`、`cus_customer`和`proj_project`均禁止`relation_id`。
