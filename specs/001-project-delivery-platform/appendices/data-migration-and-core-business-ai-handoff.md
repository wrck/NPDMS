...
| 当前目标DDL SHA-256 | `F788F56B7C1818383817D7B70279323D49D46D8DA279AEE54135E43A31C31DAA` |
| 现有证据记录的DDL SHA-256 | `2B206992BA5580E776060F9D4ED177A7BD8C34DB614FD65EC9560DAF38F8BF33` |
| 当前核心迁移表/字段 | 50表 / 1065字段；不是平台全量模型 |
| 当前约束/表选项 | 385 / 50；其中同域外键48、CHECK 78 |
...
`【P0阻断】`当前DDL、目标字段目录、完整矩阵、摘要和校验结果已使用同一当前哈希，Q07技术约束和Q08候选索引已确认，但整体模型仍未取得全量Reviewer签署和非空`approvedDdlSha256`。任何后续AI必须继续完成`AI-MIG-000`独立复核；在此之前不得把历史“52表DDL已验证”升级为当前50表核心子集放行证据，也不得把该子集冒充平台全量模型或开始生产迁移。Q08性能结论仍须由Feature查询计划和P3-E06压测形成。
