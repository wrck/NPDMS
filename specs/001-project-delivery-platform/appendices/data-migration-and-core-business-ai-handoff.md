...
| 当前目标DDL SHA-256 | `D87DD29F3420C1FD2CBB2650ABCFA0C3247747A4E6633857D2ACC2E5322B01D5` |
| 现有证据记录的DDL SHA-256 | `2B206992BA5580E776060F9D4ED177A7BD8C34DB614FD65EC9560DAF38F8BF33` |
| 当前目标表/字段 | 53表 / 1113字段 |
| 当前约束/表选项 | 433 / 53；其中外键79、CHECK 83 |
...
`【P0阻断】`当前DDL、目标字段目录、完整矩阵、摘要和校验结果已使用同一当前哈希，但整体模型仍未取得Reviewer签署和非空`approvedDdlSha256`。任何后续AI必须继续完成`AI-MIG-000`剩余逐项裁决；在此之前不得把历史“52表DDL已验证”升级为当前53表放行证据，也不得开始生产迁移。
