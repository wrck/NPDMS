...
- 数据迁移、核心项目业务、实施工作包、阻断决策、测试和切换统一从[`appendices/data-migration-and-core-business-ai-handoff.md`](appendices/data-migration-and-core-business-ai-handoff.md)开始。任何无会话上下文的AI或开发人员必须先核验其中的当前漂移状态，再承接单个工作包。
...
- `appendices/data-migration-and-core-business-ai-handoff.md`是数据迁移及核心关键业务的AI实施总入口，定义读取顺序、工作包、可执行契约、阻断决策、验证证据和切换门禁。
