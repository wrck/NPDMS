...
| [F-SOL-001](F-SOL-001-project-duration-baseline-and-change-approval.md) | 项目工期基线与变更审批 | PRE-01（V1） | BASELINE | READY（`NPDMS-FSOL001-FEATURE-READY-20260826-01-R1`） | NOT_STARTED |
| [F-PLT-001](F-PLT-001-unified-file-identity-and-version-management.md) | 统一文件身份与版本管理 | PLT-02（V1） | IN_REVIEW | NOT_READY（边界GO `NPDMS-FPLT001-BOUNDARY-20260826-01`；待Feature Ready裁决） | NOT_STARTED |
