...
| [F-SOL-003](F-SOL-003-requirement-analysis-versioning.md) | 需求分析在线填写与版本冻结 | PRE-04（V1） | IN_REVIEW | NOT_READY（待独立Feature Ready评审；边界GO `NPDMS-FSOL003-BOUNDARY-20260827-01`） | NOT_STARTED |
