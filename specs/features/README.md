...
| [F-CUT-001](F-CUT-001-cutover-unified-configuration-foundation.md) | 割接统一配置版本与采集项基础 | CUT-07（V1） | BASELINE | READY（`NPDMS-FCUT001-FEATURE-READY-20260829-01`） | IMPLEMENTATION_COMPLETE（`NPDMS-FCUT001-IMPLEMENTATION-DONE-20260830-01`；领域/服务自动化、真实MySQL、前端静态校验与真实浏览器验收通过） |
