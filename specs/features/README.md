...
| [F-CUT-009](F-CUT-009-p3-authorized-export-and-navigation.md) | P3授权清单导出与受控流程跳转 | CUT-03（V2，FULL） | BASELINE | READY / GO | IN_PROGRESS |
| [F-CUT-010](F-CUT-010-cutover-spare-system-coordination.md) | 割接备件系统协同 | CUT-08（V2，FULL） | BASELINE | READY / GO@c4b1a939 | IN_PROGRESS（Task 1公共合同与端口） |
