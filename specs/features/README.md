...
| F-COM-001统一规格收敛中（[COM-B历史规格](F-COM-001-contract-order-and-delivery-scope.md)） | 合同订单关联与交付范围管理 | COM-01（V1） | REBASELINING | NOT_READY（COM-A与COM-B按Requirement合并；统一规格尚未提交） | NOT_STARTED |
