...
| [F-IMP-001](F-IMP-001-implementation-readiness-snapshot.md) | 割接上线实施就绪快照 | EXE-06（V1，PARTIAL） | DRAFT | NOT_READY（EXE-01～04及AST设备范围事实未完成） | NOT_STARTED |
| [F-CUT-002](F-CUT-002-cutover-intake-and-manual-assessment.md) | 割接任务接入与人工分级 | CUT-01/02（V1，PARTIAL） | DRAFT | NOT_READY（硬依赖F-IMP-001及AST稳定设备范围事实） | NOT_STARTED |
