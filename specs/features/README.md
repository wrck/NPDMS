...
| [F-INS-001](F-INS-001-inspection-rule-version-and-field-configuration-foundation.md) | 巡检规则版本与字段配置基础 | INS-03（PARTIAL）、INS-09（FULL）（V2） | BASELINE | READY（`NPDMS-FINS001-FEATURE-READY-20260902-04`） | IMPLEMENTATION_IN_PROGRESS（`NPDMS-FINS001-TECHPLAN-20260830-01`；Q-FINS001-005/006已关闭，当前实施Task 8安全审核与原子发布） |
