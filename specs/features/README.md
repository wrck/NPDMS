...
| [F-AST-002](F-AST-002-device-product-type-copy-and-public-query.md) | 设备产品类型受控副本与公开查询 | EQP-01（PARTIAL，V1） | BASELINE | READY（`NPDMS-FAST002-FEATURE-READY-20260830-01`） | NOT_STARTED（下一步生成唯一Technical Plan；计划通过前不实施；不含CRM/MES连接器） |
