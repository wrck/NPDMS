...
| [F-COM-001](F-COM-001-contract-order-association-and-delivery-scope-allocation.md) | 合同订单关联与交付范围分配 | COM-01（V1） | CANDIDATE | READY_FOR_INDEPENDENT_REVIEW | NOT_STARTED |
