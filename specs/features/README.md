...
| [F-COM-001](F-COM-001-contract-order-association-and-delivery-scope-allocation.md) | 合同订单关联与交付范围分配 | COM-01（V1） | CANDIDATE | NOT_READY（Q-FCOM-001 BLOCKED_BY_SPEC） | NOT_STARTED |
