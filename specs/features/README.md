...
| [F-PROJ-008](F-PROJ-008-project-stage-gate-and-forward-advance.md) | 项目阶段准出门禁与正向推进 | PM-03（V1，PARTIAL） | CANDIDATE | NOT_READY（修订011影响同步待独立复审） | NOT_STARTED |
...
| [F-COM-001](F-COM-001-contract-order-and-delivery-scope.md) | 合同订单副本与交付范围管理 | COM-01（V1） | BASELINE | READY / GO | IN_PROGRESS（Task 1公开合同Gate） |
...
| [F-IMP-001](F-IMP-001-implementation-readiness-snapshot.md) | 割接上线实施就绪快照 | EXE-06（V1，PARTIAL） | DRAFT | NOT_READY（F-IMP-003～005及AST支撑契约待Ready评审） | NOT_STARTED |
| [F-IMP-002](F-IMP-002-arrival-acceptance.md) | 到货签收与里程碑事实 | EXE-01（V1） | BASELINE | READY / GO（`4b5a2ac9`） | NOT_STARTED |
| [F-IMP-003](F-IMP-003-hardware-installation-record.md) | 硬件安装与位置生效 | EXE-02（V1） | DRAFT | NOT_READY | NOT_STARTED |
| [F-IMP-004](F-IMP-004-configuration-log-collection.md) | 配置Log采集解析 | EXE-03（V1） | DRAFT | NOT_READY | NOT_STARTED |
| [F-IMP-005](F-IMP-005-joint-debugging-configuration.md) | 业务联调配置收集 | EXE-04（V1） | DRAFT | NOT_READY | NOT_STARTED |
| [F-CUT-002](F-CUT-002-cutover-intake-and-manual-assessment.md) | 割接任务接入与人工分级 | CUT-01/02（V1，PARTIAL） | BASELINE | READY（GO@cad8088a；生产Owner事实继续阻断真实浏览器与Implementation Done） | NOT_STARTED |
| [F-CUT-003](F-CUT-003-p3-dynamic-checklist-and-manual-fallback.md) | P3动态采集清单、直接填写与人工降级闭环 | CUT-03（V1，FULL） | BASELINE | READY（GO@ea986d61） | NOT_STARTED |
