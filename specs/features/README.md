...
| [F-INS-001](F-INS-001-inspection-rule-version-and-field-configuration-foundation.md) | 巡检规则版本与字段配置基础 | INS-03（PARTIAL）、INS-09（FULL）（V2） | BASELINE | READY（`NPDMS-FINS001-FEATURE-READY-20260830-01`） | TECHNICAL_PLAN_READY（`NPDMS-FINS001-TECHPLAN-20260830-01`；Q-FINS001-002阻断发布/选择/Done） |
