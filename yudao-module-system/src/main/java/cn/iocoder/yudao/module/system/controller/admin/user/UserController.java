...
public class UserController {
    ...
    public void importTemplate(HttpServletResponse response) throws IOException {
        ...
        List<UserImportExcelVO> list = Arrays.asList(
                UserImportExcelVO.builder().username("yunai").deptId(1L).email("yunai@example.com").mobile("15601691300")
                        .nickname("NPMS").status(CommonStatusEnum.ENABLE.getStatus()).sex(SexEnum.MALE.getSex()).build(),
    ...
    @Parameter(name = "nickname", description = "昵称关键词", required = true, example = "NPMS")
