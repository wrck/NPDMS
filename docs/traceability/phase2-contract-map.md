...
> 文档状态：`BASELINE`
> 适用基线：PRD V1.8 修订012（`docs/baseline/prd-v1.8.md`）；修订011安全差量与修订012规则名称稳定身份差量已回写正式SDS
