...
| `ddl-drift-review.md` | 当前 DDL 哈希`3CDDE2...D58BC`与旧目录哈希`2B2069...BF33`不一致，裁决为`DEFER` | 数据概念与已确认业务规则可继续设计；任何实际 DDL/迁移发布必须先完成`AI-MIG-000` | 引用旧`passed=true`、52表/1076列等结果宣称当前迁移可执行 |
