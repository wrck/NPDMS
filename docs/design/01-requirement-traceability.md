...
| CUT 割接与稳定治理 | 割接任务、问卷分级、采集清单、方案、分级审批、P6闭环和配置 | CUT-01～CUT-10 | CutoverTask、CutoverAssessment、CutoverPlan、CutoverClosure | OWNER_SIGNED |
