...
> Requirement ID：PRD V1.7 附录 A.1 的全部 104 项 V1/V2 正式需求
> 文档 Owner：需求方；本文件仅登记业务事实 Owner 映射，不替代实施责任人名册
> 依据：PRD V1.7 第四至第十三章、附录 A.1、核心业务对象和数据关联规则
> 领域规格：`specs/001-project-delivery-platform/domains/`由PRD V1.7生成；PRD仍是最高业务语义来源
...
| ACC | ACC-01～ACC-06、CLO-01～CLO-02 | 验收、满意度收集、交付件齐套校验、审核、统一归档、闭环和持续服务交接 |
| CUT | CUT-01～CUT-11 | 割接任务及其评估、审批、执行、割接保障任务和稳定治理 |
...
| 需求唯一 Owner | `PASS` | 104 项正式需求唯一归属，追溯矩阵校验通过 |
