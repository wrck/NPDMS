...
| 客户与关系 | 客户、联系人、客户关系、服务等级时态版本和同步副本 | Customer、Contact、AssetRelation、CustomerServiceLevelRevision | CRM、Project、Asset Management、基础平台字典 | CustomerUpdated、CustomerServiceLevelChanged、CustomerSyncCompleted | 直接改变项目流程、回写历史业务等级快照 |
