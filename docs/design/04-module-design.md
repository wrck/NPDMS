...
| 割接 | 任务、评估、采集清单、方案、审批、执行和割接保障 | CutoverTask、CutoverPlan、CutoverSupportTask、ResponsibilityInterval | Project、Device、CollectionTask | CutoverApproved、CutoverSupportTaskChanged、CutoverCompleted | 直接访问采集引擎、建设通用工单 |
