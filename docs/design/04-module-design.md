...
| 实施执行 | 到货签收、工勘地点维护、安装/迁移/拆除及位置生效事实、配置Log采集业务结果、联调、割接前实施就绪快照、风险、阶段质量检查、实施阶段交付件/证据上传 | ArrivalAcceptance、InstallationRecord、ConfigurationCollectionResult、JointDebuggingResult、ImplementationReadinessSnapshot、ImplementationRisk、ImplementationQualityCheck、DeliveryEvidence | ProjectScopeApi、DeviceScopeFactApi、AssetLocationApi、CollectionTask、File、EXE-01～04 Owner公开事实契约 | ConfigurationLogPublished、ImplementationReadinessSnapshotPublished、DeliveryEvidenceUploaded、ImplementationQualityChecked、ImplementationReadinessApi | 直接执行设备命令、持有AST地点DO/Mapper/Repository、直读EXE-01～04业务表、拥有ConfigurationLog原始文件/不可变解析版本、直接改变CUT或验收归档状态；IMP-02安全检查不属于当前模块 |
...
| 客户与关系 | 客户、联系人、客户关系、服务等级时态版本、客户地点引用和同步副本 | Customer、Contact、AssetRelation、CustomerServiceLevelRevision | CRM、Project、AssetLocationApi、基础平台字典 | CustomerServiceLevelFactApi、CustomerUpdated、CustomerServiceLevelChanged、CustomerSyncCompleted | 拥有物理地点实体或表、直接改变项目流程、回写历史业务等级快照 |
