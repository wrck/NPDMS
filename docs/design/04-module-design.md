...
| 验收与闭环 | 培训、满意度收集、初验/终验报告、交付件齐套校验、审核、统一归档、闭环交接；按项目阶段快照记录进入验收范围的DeliveryScope分配版本 | Acceptance、AcceptanceScopeBinding、SatisfactionCollection、ProjectClosure、Artifact | ProjectStageSnapshot、DeliveryEvidence、DeliveryScopeAcceptanceLockApi、File、Questionnaire | AcceptanceScopeBindingApi、AcceptanceScopeGuardApi、SatisfactionResultRecorded、ArtifactAccepted、ProjectClosureCompleted、ServiceHandoverCreated | 直接改PROJ阶段、COM范围或财务事实，直接修改现场实施原始证据，持有COM/PROJ的DO/Mapper/Repository，使用报告状态触发范围绑定 |
