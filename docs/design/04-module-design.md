...
> 文档状态：`BASELINE`
> 适用基线：PRD V1.8修订013及批准增量`CHG-PRD-2026-08-23-002`
...
| 巡检 | INS-01～INS-09巡检任务、规则、报告和问题 | InspectionTask、InspectionRule、ServiceIssue | Device、Device Access & Collection、UMC、基础平台字典 | InspectionCompleted、IssueCreated | 读取凭证明文、维护第二套检测分类或严重度主数据 |
