...
> Requirement ID：全部 115 项 V1/V2 正式需求中的查询性能和并发一致性；重点覆盖 PM-02/04/09/11、PROJ-12、EXE、CUT、INS、EQP、AST-01～02、COM-01～02、PLT、INT-12、NFR-01～02
...
| 容量和 TTL 数值 | IN_REVIEW | Phase 3 性能验证后登记，不作为业务规则臆造 |
