...
- **Ownership and dependency direction:** PROJ owns project/template/participant facts, PLT owns Artifact/Version/Reference, SOL owns PRE-04, SYSTEM owns dictionaries, and future SCH consumes only engineering-api. No module reads another Context's table or depends on another module's biz Service/Mapper/DO.
