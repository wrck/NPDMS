...
| 文件 | 用途 |
|---|---|
| `prd-v1.8.md` | PRD V1.8修订012的当前内容快照，已合并修订001—012，供SDS、Feature和测试读取；不得直接编辑 |
...
5. 基线生效后的业务变化必须通过CHG-01记录影响、批准和新版本；当前快照已合并修订001—012，增量文件只作为批准依据和审计追溯，不得在读取快照后重复叠加。
