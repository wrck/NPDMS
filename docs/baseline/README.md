...
| 文件 | 用途 |
|---|---|
| `prd-v1.8.md` | PRD V1.8修订013的当前内容快照，已合并修订001—013，供SDS、Feature和测试读取；不得直接编辑 |
...
| `prd-v1.8-amendment-009-inspection-command-timeout-limit.md` | 已批准修订：巡检单命令超时统一为1～30秒 |
| `prd-v1.8-amendment-010-asset-product-type-public-contract.md` | 已批准修订：AST产品类型受控副本与公开查询契约 |
| `prd-v1.8-amendment-011-inspection-regex-subset.md` | 已批准修订：巡检预期结果正则采用JDK 25受限子集 |
| `prd-v1.8-amendment-012-inspection-rule-name-identity.md` | 已批准修订：巡检规则名称归属稳定身份并在租户内永久唯一 |
| `prd-v1.8-amendment-013-inspection-security-review-effect-and-explicit-authorization.md` | 已批准修订：巡检安全审核最后事实生效与System显式RBAC授权事实契约 |
...
5. 基线生效后的业务变化必须通过CHG-01记录影响、批准和新版本；当前快照已合并修订001—013，增量文件只作为批准依据和审计追溯，不得在读取快照后重复叠加。
