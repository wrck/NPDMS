...
> 适用基线：`docs/baseline/prd-v1.8.md`（已合并修订001—013）；批准依据与审计追溯见`docs/baseline/prd-v1.8-amendment-001-no-manual-project-draft.md`至`docs/baseline/prd-v1.8-amendment-013-inspection-security-review-effect-and-explicit-authorization.md`<br>
