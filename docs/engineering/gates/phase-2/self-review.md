...
| S2-V18-16 | F-ACC-001形成ACC-03完整报告闭环与ACC-04初验/终验来源切片 | 当前候选为94对象/109来源绑定/1排除源；ADR-0039及02/04/05/06/08/08a/09/10/11/15/16锁定活动与报告版本分离、PROJ任务Owner、四项完备、终验初验守卫、既有`acc_project_deliverable`唯一索引根、异步归档补偿、范围绑定回归和旧V17不复用边界；待独立复审，不放行Feature Spec或实施 |
