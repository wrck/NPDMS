...
| S2-V18-13 | PRD修订008更正COM-01订单范围地点并触发F-COM-001聚焦物理复核 | 当前候选契约为94对象/107来源绑定/1排除源；办事处发生时快照、PROJ/ACC窄Owner契约、精确物理字段和V70失败关闭规则已形成候选；P3-E09差量待独立复审，Q-FCOM-001继续BLOCKED_BY_SPEC，不改变Phase 2总体历史结论 |
