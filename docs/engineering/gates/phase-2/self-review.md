...
| S2-V18-17 | F-ACC-001补齐PLT稳定公共文件事实、ACC文件策略/归档Owner接口及活动初始化/存量切换 | ADR-0040与02d/04/08/08a/09/10/11/13/15/16形成整改候选；附件ACTIVE引用与独立ARCHIVED归档引用分离，attach目标加性支持ACC；存量两项均终态保持、混合状态失败；待独立复审 |
