...
| S2-V18-14 | PRD修订009补充项目阶段、验收范围与验收报告有序事实 | ADR-0037候选及02/04/05/06/08/08a/09/10/11/15/16已同步：ProjectStageSnapshot成为绑定来源，报告与绑定解耦，进入/新范围两条路径同事务、统一PROJ→COM→ACC锁序；`acceptance_id`从候选物理差量删除，Q-FCOM-002继续窄阻断，等待独立复审 |
