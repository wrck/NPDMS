...
| F-CUT-010聚焦CUT-08候选 | IN_REVIEW | 当前契约为96对象/107来源绑定/1排除源；外部申请引用、状态revision和人工证据为NONE_NEW/FEATURE_FORWARD_MIGRATION(CUT-08)，仅关闭Phase 2载体冲突，不代表Feature Ready通过 |
