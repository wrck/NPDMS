...
| F-PROJ-008 PM-03阶段准出与相邻推进 | IN_REVIEW | ADR-0043候选锁定S0→S4通用相邻推进、六类GateRef稳定Owner/满足谓词、PMS窄版本化流程Owner命令及专用发起授权/initiator语义、空Gate失败关闭、原子状态/快照/事件和P3-E09 `NO_PHYSICAL_DELTA`；未获独立GO前不得进入Feature Spec |
