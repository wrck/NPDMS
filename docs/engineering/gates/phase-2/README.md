...
> 迁移边界：81对象、92来源绑定、1排除源；P3-E09=`MODEL_BASELINE_READY`；仅当发布包含历史迁移或数据切换时，才由`AI-MIG-000`作为Release前置门禁并绑定批准窗口，普通功能发布不适用
...
- [`self-review.md`](self-review.md)：本轮V1.8 Phase 2 差量自审，当前保持 `REVALIDATION_REQUIRED`。
- [`independent-review.md`](independent-review.md)：本轮V1.8独立复审待执行记录；旧V1.7结论不作为放行依据。
