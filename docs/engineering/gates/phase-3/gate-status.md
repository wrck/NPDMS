...
| 数据模型DDL/映射基线一致 | BLOCKED_BY_MODEL_DECISION（ADR-0019命名、ADR-0020项目编码、ADR-0021市场行业四维分类、ADR-0022核心迁移边界已应用；当前49表、1,048列、380项约束和全部迁移目标引用使用同一DDL哈希，4张V3治理表及跨领域物理外键已移除；P3-E09 / AI-MIG-000仍需其余同域约束、表选项及全量Reviewer签署） |
