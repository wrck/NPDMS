# Review package: T-CP-008 closure re-review

Base: 38c5018
Head: 7ec72dc9633e30eac2381fd34afa95c424d8cdb7
...
```text
 ...
 pom.xml                                            |   4 +
 tasks/todo.md                                      |   6 +-
 .../verify-pms-module-boundaries-test.ps1          | 212 +++++++++++++++++++++
 .../verify-pms-module-boundaries.ps1               | 211 ++++++++++++++++++++
...
+            $content -match "(?m)^\s*public\s+(?:(?:data|sealed|enum)\s+)?(?:interface|class)\b"
