# Review package: T-CP-008 dependency parsing re-review

Base: 38c5018
Head: 8ccc650126bb2d41932b179a3377dbde5b48f274
...
```text
 ...
 pom.xml                                            |   4 +
 tasks/todo.md                                      |   6 +-
 .../verify-pms-module-boundaries-test.ps1          | 249 ++++++++++++++++++
 .../verify-pms-module-boundaries.ps1               | 289 +++++++++++++++++++++
 yudao-server/pom.xml                               |  20 ++
 14 files changed, 643 insertions(+), 3 deletions(-)
```
...
+        [pscustomobject]@{
+            ArtifactId = Resolve-MavenPropertyValue -Value $artifactId -Properties $properties
...
+    if ($null -ne $parent) {
+        $relativePath = Get-MavenChildText -Node $parent -ElementName "relativePath"
...
+            foreach ($property in (Get-MavenProjectProperties -PomPath $parentPomPath).GetEnumerator()) {
