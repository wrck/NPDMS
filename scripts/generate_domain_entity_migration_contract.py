...
OVERRIDES: dict[str, list[dict[str, str]]] = {
    ...
    "DeliveryEvidence": [source("CURRENT_TABLE", "pms_eng_deliverable", "CURRENT_FORWARD", "F-IMP-002 maps only RECEIPT rows whose source resolves to ArrivalAcceptance and whose file already resolves to a valid PLT FileReference; legacy collected/void status never infers ACC accepted/archived and binary is not redownloaded or copied; other deliverable types remain pending for the IMP-01 Owner Feature", "PARTIAL_FEATURE_MAPPING_DEFINED", "F-IMP-002_FEATURE_READY_REVIEW / IMP-01_OWNER_FEATURE")],
