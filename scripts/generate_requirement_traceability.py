...
def render(
    ...
    lines = [
        ...
        "> 批准修订：`CHG-PRD-2026-09-01-011`（收敛两条修订007后并行基线，保留COM/ACC/问卷与CUT双机97项语义，并统一BPM定义身份）。",
        ...
        "- 当前状态：PRD V1.8修订011正式基线；既有Feature实施结论只关闭其机器可读声明覆盖的切片或子闭环，不因Feature完成自动关闭整个Requirement",
