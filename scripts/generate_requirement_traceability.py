...
def render(
    ...
    coverage_document = {
        "schemaVersion": 1,
        "baseline": "PRD V1.8 / CHG-PRD-2026-08-30-010",
        "sources": {
    ...
    lines = [
        ...
        "> 批准修订：`CHG-PRD-2026-08-30-009`（统一巡检单命令超时为1～30秒，不保留未定义的超时审批扩展）。",
        "> 批准修订：`CHG-PRD-2026-08-30-010`（AST拥有设备产品类型受控副本与公开查询，Inspection失败关闭消费；不实现CRM/MES连接器）。",
