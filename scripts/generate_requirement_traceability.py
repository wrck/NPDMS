...
CROSS_CONTEXT_REQUIREMENT_IDS = {
    ...
    "INT-06", "INT-12", "PM-03", "PM-08", "PM-11", "PLT-02", "SRV-01", "SUB-03",
}
...
def render(
    ...
    lines = [
        ...
        "> 批准修订：`CHG-PRD-2026-09-01-009`（选择PROJ分支已批准的BPM定义身份语义进入master，不导入并行COM/ACC修订）。",
        "> 批准修订：`CHG-PRD-2026-09-02-010`（按Requirement合并COM-A与COM-B，统一COM地点Owner、人工候选对账、项目范围版本与ACC精确版本绑定）。",
