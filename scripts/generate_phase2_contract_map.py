...
GROUPS: list[tuple[tuple[str, ...], Contract]] = [
    ...
    (("ACC-04",), contract("DeliveryArtifact", "acc_project_deliverable、acc_project_deliverable_source_version、acc_project_deliverable_source_attachment、acc_artifact_review、acc_archive_record", "/delivery-artifacts", events="ArtifactAccepted/Archived、ClosureGateRecheckRequested", files="FileArtifact/FileVersion完整有序集合", workflow="以acc_project_deliverable为唯一应交根；来源版本/附件关系只追加，替换保留旧关系，撤销使当前失效且不恢复旧版；归档失败保留历史并重校验CLO；F-ACC-001只实现初验/终验来源切片，其余来源与统一批量下载留待完整Feature", authorization="ProjectStageScope、FileBusinessScope；ACC归档")),
