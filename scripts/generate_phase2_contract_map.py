...
GROUPS: list[tuple[tuple[str, ...], Contract]] = [
    ...
    (('ACC-03',), contract('AcceptanceReportRevision', 'acc_acceptance_report、acc_acceptance_report_revision', "/acceptances", files="FileArtifact", workflow='字段/附件完整只形成证据；明确通过且顺序合法、当前范围完整覆盖才满足门禁；同类型一个当前报告，A+B须新总体明确通过', authorization="ProjectStageScope、FileBusinessScope")),
    ...
    (('ACC-04',), contract("DeliveryArtifact", "acc_delivery_artifact、acc_artifact_review、acc_archive_record", "/delivery-artifacts", events="ArtifactAccepted/Archived", files="FileArtifact", workflow='索引有效来源/版本/哈希/结论与范围；失败验收证据可归档但不满足通过门禁；下载权限不改变客观齐套', authorization="ProjectStageScope、FileBusinessScope；ACC归档")),
