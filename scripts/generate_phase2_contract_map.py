...
GROUPS: list[tuple[tuple[str, ...], Contract]] = [
    ...
    (("EXE-06",), contract("ImplementationReadinessSnapshot", "imp_implementation_readiness_snapshot", "/implementation-readiness/{projectId}", events="ImplementationReadinessSnapshotPublished", workflow="就绪门禁汇总、快照发布与CUT消费", authorization="ImplementationProjectCutoverScope")),
