...
GROUPS: list[tuple[tuple[str, ...], Contract]] = [
    ...
    (("ACC-03",), contract("Acceptance", "acc_acceptance、acc_acceptance_item、acc_confirmation", "/acceptances", files="FileArtifact", workflow="报告提交、确认和问题留痕", authorization="ProjectStageScope、FileBusinessScope")),
