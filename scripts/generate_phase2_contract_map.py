...
GROUPS: list[tuple[tuple[str, ...], Contract]] = [
    ...
    (("CUT-04",), contract("CutoverPlan、CutoverSupportArrangement", "cut_plan_revision、cut_step、cut_cutover_support_arrangement", "/cutover-tasks/{id}/plan、/cutover-tasks/{id}/plan/actions/{create-draft|download-draft|submit|revise}", events="N/A（P4通过同步CutoverApprovalStartPort创建CUT-05审批实例；CutoverApproved仅由CUT-05发布）", files="FileArtifact", workflow="P4方案编制、不可变revision和与P5审批实例原子交接；审批状态由CUT-05拥有", authorization="CutoverTaskScope；方案查询/保存/下载/提交权限")),
