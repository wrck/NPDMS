...
GROUPS: list[tuple[tuple[str, ...], Contract]] = [
    ...
    (("INT-04",), contract("TechnicalNoticeReference", "kno_technical_notice、kno_notice_business_reference", "/technical-notices、/technical-notices/{id}/references", events="TechnicalNoticeSynchronized", integration="ITR", workflow="公告镜像、版本同步和业务引用", authorization="ProductDeviceProjectScope；V2只读")),
