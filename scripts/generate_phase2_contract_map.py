...
GROUPS: list[tuple[tuple[str, ...], Contract]] = [
    ...
    (('PM-03',), contract('ProjectTemplateVersion、StageTransitionDefinition、Stage/TaskWorkBinding、ProjectStageSnapshot', '既有PROJ模板/阶段/快照承载；图与Stage绑定物理差量见09分册及受影响Feature，未重验证不得声称NO_PHYSICAL_DELTA', "/project-templates", workflow='冻结图发布校验；当前CompletionRule/准出→唯一后置→目标准入→原子推进；售前仅S0/S4，无虚构阶段', authorization="项目模板维护权限；项目阶段范围；非TASK_NATIVE绑定目标权限不得越权")),
