...
class Phase3EvidencePacketTest(unittest.TestCase):
    def test_packet_coverage_and_decisions(self) -> None:
        ...
        self.assertEqual(258, packets["P3-E09"]["confirmedFacts"]["q07Decision"]["technicalConstraintCount"])
        self.assertEqual(124, packets["P3-E09"]["confirmedFacts"]["q08Decision"]["candidateIndexCount"])
