...
class Phase3EvidencePacketTest(unittest.TestCase):
    def test_packet_coverage_and_decisions(self) -> None:
        ...
        self.assertEqual(222, packets["P3-E09"]["confirmedFacts"]["q07Decision"]["technicalConstraintCount"])
        self.assertEqual(108, packets["P3-E09"]["confirmedFacts"]["q08Decision"]["candidateIndexCount"])
