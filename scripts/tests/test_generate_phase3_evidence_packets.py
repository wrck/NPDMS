...
class Phase3EvidencePacketTest(unittest.TestCase):
    ...
    def test_packet_coverage_and_decisions(self) -> None:
        ...
        self.assertEqual("HISTORICAL_ACCEPTED", packets["P3-E09"]["confirmedFacts"]["v17DeltaStatus"])
        self.assertEqual("ACCEPTED", packets["P3-E09"]["confirmedFacts"]["v18DeltaStatus"])
        self.assertEqual(2079, packets["P3-E09"]["confirmedFacts"]["decisionRegisterItemCount"])
        ...
        self.assertEqual("HISTORICAL_ACCEPTED", packets["P3-E09"]["confirmedFacts"]["requirementOwnerConfirmation"]["status"])
        ...
        self.assertEqual(282, packets["P3-E09"]["confirmedFacts"]["q07Decision"]["technicalConstraintCount"])
        self.assertEqual(130, packets["P3-E09"]["confirmedFacts"]["q08Decision"]["candidateIndexCount"])
