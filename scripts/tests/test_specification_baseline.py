...
class SpecificationBaselinePathTest(unittest.TestCase):
    def test_allowlist_contains_exactly_101_files(self) -> None:
        ...
        self.assertEqual(101, len({entry.path for entry in entries}))
