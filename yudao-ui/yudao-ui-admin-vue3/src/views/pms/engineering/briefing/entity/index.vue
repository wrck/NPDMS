...
import * as BriefingApi from '@/api/pms/engineering/briefing/entity'
import * as ProjectApi from '@/api/pms/project/projects'
import * as UserApi from '@/api/system/user'
import type { BriefingVO } from '@/api/pms/engineering/briefing/entity'
import ProjectTag from '@/components/ProjectTag/index.vue'
import UserTag from '@/components/UserTag/index.vue'

defineOptions({ name: 'PmsEngBriefingEntity' })
...
const openCreate = () => {
  // 编辑后再新建时清空全部旧快照和文件元数据，避免上一个对象的数据串入新对象。
  Object.assign(form, {
