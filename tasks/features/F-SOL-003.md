...
> 锁定规格提交：`9417079eda9e64ca5ecc23373c86431434800f83`

## 当前最小工作单元

- 完成新中文 Technical Plan 独立评审；通过后按一个整体正向闭环实施，全部接通后统一执行整体测试和验收。

> 检查点（2026-08-28）：基线`9417079`已同步NPDMS `8837c273`；当前Gate为Technical Plan；Feature Ready六项整改及全量387项规格测试已通过，旧计划/审查均取消；无阻塞；下一步独立评审新中文整体计划，GO后再实施。
