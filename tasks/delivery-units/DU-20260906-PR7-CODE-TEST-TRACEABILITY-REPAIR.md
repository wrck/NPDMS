...
> 认领提交：`SELF`
> 修改边界：`.github/**;pms-module-engineering/**;pms-module-engineering-api/**;pms-module-commerce/**;pms-module-cutover/**;pms-module-platform/**;pms-module-project/**;scripts/**;tasks/features/**;specs/features/**;docs/traceability/**;docs/engineering/gates/**;docs/decisions/open-questions.md;tasks/delivery-units/DU-20260906-PR7-CODE-TEST-TRACEABILITY-REPAIR.md;tasks/delivery-units/README.md;yudao-ui/yudao-ui-admin-vue3/**`
...
用户要求修复`757ec7c8eb4df9b18658191176ae5e029f0fbcc5`上的实际问题。本次只扩展既有认领到EXE-06公开就绪事实输入校验及待确认事项登记；不实现F-IMP-001生产Provider，不改变租户0/正整数合同或迁移历史审批规则。COM负向测试保留平台幂等和业务表均不写入的强断言；CUT重复桩只去重；任务与投影不得因登记归零而宣称语义等价或Feature Done。
