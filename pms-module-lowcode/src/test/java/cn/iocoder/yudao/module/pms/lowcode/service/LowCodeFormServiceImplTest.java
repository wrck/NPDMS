...
import cn.iocoder.yudao.module.pms.lowcode.service.impl.LowCodeFormServiceImpl;
...
class LowCodeFormServiceImplTest {
    ...
    void create_shouldThrowWhenCodeDuplicated() {
        ...
        LowCodeException ex = assertThrows(LowCodeException.class, () -> service.create(form));
    ...
    void update_shouldThrowWhenNotFound() {
        ...
        assertThrows(LowCodeException.class, () -> service.update(toUpdate));
    ...
    void delete_shouldThrowWhenNotFound() {
        ...
        assertThrows(LowCodeException.class, () -> service.delete(404L));
    ...
    void publish_shouldThrowWhenNotDraft() {
        ...
        assertThrows(LowCodeException.class, () -> service.publish(1L));
        verify(baseMapper, never()).updateById(any(LowCodeForm.class));
    }
    ...
    void archive_shouldThrowWhenNotPublished() {
        ...
        assertThrows(LowCodeException.class, () -> service.archive(1L));
        verify(baseMapper, never()).updateById(any(LowCodeForm.class));
    }
    ...
    void exportConfig_shouldThrowWhenNotFound() {
        ...
        assertThrows(LowCodeException.class, () -> service.exportConfig("NOT_EXIST"));
    }
    ...
    void importConfig_shouldThrowWhenCodeMissing() {
        ...
        assertThrows(LowCodeException.class, () -> service.importConfig(json));
        verify(baseMapper, never()).insert(any(LowCodeForm.class));
    }
    ...
    void importConfig_shouldThrowWhenJsonBlank() {
        assertThrows(LowCodeException.class, () -> service.importConfig(""));
        assertThrows(LowCodeException.class, () -> service.importConfig(null));
    }
