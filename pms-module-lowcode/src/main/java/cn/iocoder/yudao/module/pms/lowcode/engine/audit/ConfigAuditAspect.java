package cn.iocoder.yudao.module.pms.lowcode.engine.audit;

import cn.iocoder.yudao.framework.security.core.util.SecurityFrameworkUtils;
import cn.iocoder.yudao.module.pms.lowcode.service.LowCodeConfigAuditLogService;
 ...
 * before/after 快照到 {@code low_config_audit_log}。</p>
 *
...
public class ConfigAuditAspect {
    ...
    private static final String POINTCUT =
            "(execution(* cn.iocoder.yudao.module.pms.lowcode.service.impl.LowCodeEntityServiceImpl.save*(..)) ||"
            + " execution(* cn.iocoder.yudao.module.pms.lowcode.service.impl.LowCodeEntityServiceImpl.update*(..)) ||"
            + " execution(* cn.iocoder.yudao.module.pms.lowcode.service.impl.LowCodeEntityServiceImpl.remove*(..)) ||"
            + " execution(* cn.iocoder.yudao.module.pms.lowcode.service.impl.LowCodeEntityServiceImpl.delete*(..)) ||"
            + " execution(* cn.iocoder.yudao.module.pms.lowcode.service.impl.LowCodeFormServiceImpl.save*(..)) ||"
            + " execution(* cn.iocoder.yudao.module.pms.lowcode.service.impl.LowCodeFormServiceImpl.update*(..)) ||"
            + " execution(* cn.iocoder.yudao.module.pms.lowcode.service.impl.LowCodeFormServiceImpl.remove*(..)) ||"
            + " execution(* cn.iocoder.yudao.module.pms.lowcode.service.impl.LowCodeFormServiceImpl.delete*(..)) ||"
            + " execution(* cn.iocoder.yudao.module.pms.lowcode.service.impl.LowCodeListServiceImpl.save*(..)) ||"
            + " execution(* cn.iocoder.yudao.module.pms.lowcode.service.impl.LowCodeListServiceImpl.update*(..)) ||"
            + " execution(* cn.iocoder.yudao.module.pms.lowcode.service.impl.LowCodeListServiceImpl.remove*(..)) ||"
            + " execution(* cn.iocoder.yudao.module.pms.lowcode.service.impl.LowCodeListServiceImpl.delete*(..)) ||"
            + " execution(* cn.iocoder.yudao.module.pms.lowcode.service.impl.LowCodeTabServiceImpl.save*(..)) ||"
            + " execution(* cn.iocoder.yudao.module.pms.lowcode.service.impl.LowCodeTabServiceImpl.update*(..)) ||"
            + " execution(* cn.iocoder.yudao.module.pms.lowcode.service.impl.LowCodeTabServiceImpl.remove*(..)) ||"
            + " execution(* cn.iocoder.yudao.module.pms.lowcode.service.impl.LowCodeTabServiceImpl.delete*(..)) ||"
            + " execution(* cn.iocoder.yudao.module.pms.lowcode.service.impl.LowCodeRelatedPageServiceImpl.save*(..)) ||"
            + " execution(* cn.iocoder.yudao.module.pms.lowcode.service.impl.LowCodeRelatedPageServiceImpl.update*(..)) ||"
            + " execution(* cn.iocoder.yudao.module.pms.lowcode.service.impl.LowCodeRelatedPageServiceImpl.remove*(..)) ||"
            + " execution(* cn.iocoder.yudao.module.pms.lowcode.service.impl.LowCodeRelatedPageServiceImpl.delete*(..)) ||"
            + " execution(* cn.iocoder.yudao.module.pms.lowcode.service.impl.LowCodeMicroflowServiceImpl.save*(..)) ||"
            + " execution(* cn.iocoder.yudao.module.pms.lowcode.service.impl.LowCodeMicroflowServiceImpl.update*(..)) ||"
            + " execution(* cn.iocoder.yudao.module.pms.lowcode.service.impl.LowCodeMicroflowServiceImpl.remove*(..)) ||"
            + " execution(* cn.iocoder.yudao.module.pms.lowcode.service.impl.LowCodeMicroflowServiceImpl.delete*(..)) ||"
            + " execution(* cn.iocoder.yudao.module.pms.lowcode.service.impl.LowCodeRuleServiceImpl.save*(..)) ||"
            + " execution(* cn.iocoder.yudao.module.pms.lowcode.service.impl.LowCodeRuleServiceImpl.update*(..)) ||"
            + " execution(* cn.iocoder.yudao.module.pms.lowcode.service.impl.LowCodeRuleServiceImpl.remove*(..)) ||"
            + " execution(* cn.iocoder.yudao.module.pms.lowcode.service.impl.LowCodeRuleServiceImpl.delete*(..)) ||"
            + " execution(* cn.iocoder.yudao.module.pms.lowcode.service.impl.LowCodeConnectorServiceImpl.save*(..)) ||"
            + " execution(* cn.iocoder.yudao.module.pms.lowcode.service.impl.LowCodeConnectorServiceImpl.update*(..)) ||"
            + " execution(* cn.iocoder.yudao.module.pms.lowcode.service.impl.LowCodeConnectorServiceImpl.remove*(..)) ||"
            + " execution(* cn.iocoder.yudao.module.pms.lowcode.service.impl.LowCodeConnectorServiceImpl.delete*(..)))";
    ...
    public Object auditConfigWrite(ProceedingJoinPoint joinPoint) throws Throwable {
        ...
        try {
            ...
            try {
                String actor = SecurityFrameworkUtils.getLoginUserNickname();
    ...
    private Object safeLoadById(String serviceImplName, Long id) {
        ...
        try {
            ...
            Object bean = cn.iocoder.yudao.module.pms.lowcode.util.SpringApplicationContextHolder
                    .getBean(beanName);
