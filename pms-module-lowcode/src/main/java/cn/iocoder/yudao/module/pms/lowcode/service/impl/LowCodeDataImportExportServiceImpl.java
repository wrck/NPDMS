...
import cn.iocoder.yudao.module.pms.lowcode.engine.dataio.LowCodeImportAsyncProcessor;
import cn.iocoder.yudao.module.pms.lowcode.entity.LowCodeBackupRecord;
...
import cn.iocoder.yudao.module.pms.lowcode.mapper.LowCodeBackupRecordMapper;
import cn.iocoder.yudao.module.pms.lowcode.mapper.LowCodeImportTaskMapper;
...
public class LowCodeDataImportExportServiceImpl
    ...
    public LowCodeImportTask importExcel(String entityCode, MultipartFile file) {
        ...
        LowCodeImportTask task = LowCodeImportTask.builder()
                ...
                .successRows(0)
                .failedRows(0)
                .operator(SecurityFrameworkUtils.getLoginUserNickname())
                .build();
