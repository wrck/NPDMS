...
import cn.iocoder.yudao.module.pms.lowcode.entity.LowCodeMicroflowExecutionLog;
import cn.iocoder.yudao.module.pms.lowcode.mapper.LowCodeMicroflowExecutionLogMapper;
...
public class LowCodeMicroflowExecutionLogController {
    ...
    public CommonResult<List<LowCodeMicroflowExecutionLog>> getByExecutionId(@PathVariable String executionId) {
    ...
    @GetMapping("/recent")
    @PreAuthorize("@ss.hasPermission('lowcode:microflow:exec')")
    public CommonResult<List<LowCodeMicroflowExecutionLog>> getRecent(
