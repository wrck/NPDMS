...
import cn.iocoder.yudao.module.pms.lowcode.entity.LowCodeConfigAuditLog;
import cn.iocoder.yudao.module.pms.lowcode.mapper.LowCodeConfigAuditLogMapper;
...
public class LowCodeConfigAuditLogController {
    ...
    public CommonResult<Page<LowCodeConfigAuditLog>> page(
    ...
    @GetMapping("/{id}")
    @PreAuthorize("@ss.hasPermission('lowcode:config-audit:list')")
    public CommonResult<LowCodeConfigAuditLog> get(@PathVariable Long id) {
        return CommonResult.success(auditLogMapper.selectById(id));
    }
}
