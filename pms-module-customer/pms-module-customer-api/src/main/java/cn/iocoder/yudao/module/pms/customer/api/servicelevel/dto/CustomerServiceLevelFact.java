...
/** 当前客户服务等级时间线事实。 */
public record CustomerServiceLevelFact(
        Status status,
        Long tenantId,
        Long customerId,
    ...
    public CustomerServiceLevelFact {
        ...
        if (status == Status.AVAILABLE) {
            ...
            require(serviceLevelRevisionId == null && serviceLevelCode == null
                    ...
                    "NOT_CONFIGURED must not fabricate revision or effective interval");
        }
    }
    ...
    private static void require(boolean condition, String message) {
        if (!condition) {
            throw new CustomerServiceLevelFactException(
                    CustomerServiceLevelFactException.Code.OWNER_DATA_CORRUPTED, message);
        }
    }
