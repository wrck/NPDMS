...
|---|---|---|---|---|
| F-PM03 项目模板基座 | PM-03 | 模板/版本/四维匹配/发布校验/阶段-任务-里程碑-交付件-门禁定义与匹配查询（供给端） | 无 | V1_8_REVALIDATION_REQUIRED |
| F-PM01 项目手动创建 | PM-01 | 手动创建表单、模板选择+默认唯一命中、实例化冻结、S0初始化、人工指派服务经理 | F-PM03 | V1_8_REVALIDATION_REQUIRED |
| F-PM02 项目树与详情 | PM-02 | 项目树关系、无环移动、按需加载查询、进度汇总口径、项目详情 | F-PM01、F-PM03 | V1_8_REVALIDATION_REQUIRED |
