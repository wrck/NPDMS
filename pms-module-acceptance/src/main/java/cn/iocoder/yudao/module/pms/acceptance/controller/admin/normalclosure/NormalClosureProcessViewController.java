...
import cn.iocoder.yudao.module.pms.acceptance.service.normalclosure.NormalClosureQueryService;
import cn.iocoder.yudao.module.pms.acceptance.service.normalclosure.NormalClosureViews;
...
public class NormalClosureProcessViewController {
    ...
    public CommonResult<NormalClosureViews.ApplicationDetail> detail(@PathVariable @Positive Long id) {
        return trusted(() -> success(query.processViewByApplicationId(id, new Actor(
