...
class ProjectDeliverablePlanChangesTest {
    ...
    @BeforeEach void setup() {
        ...
        when(mapper.selectByIdForUpdate(any())).thenAnswer(call -> current(call.<cn.iocoder.yudao.module.pms.project.dal.mysql.acceptance.query.ProjectDeliverableIdLockQuery>getArgument(0).deliverableId()));
