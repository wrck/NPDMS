...
class Facc002MigrationContractTest {
    ...
    @Test
    void v133MustCreateOrRevalidateOneCompleteManagedState() throws Exception {
        String sql = Files.readString(Path.of("..", "sql", "migrations",
                "V133__facc002_satisfaction_questionnaire_result_forward.sql"));
    ...
    @Test
    void v133MustFreezePermissionsAndAllFiveRuntimeJobs() throws Exception {
        String sql = Files.readString(Path.of("..", "sql", "migrations",
                "V133__facc002_satisfaction_questionnaire_result_forward.sql"));
